    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href=""><img src="{{asset('public/frontend/image/logo.jpg')}}" style="height: 93px;  "></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ar me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="contact.html"style="color: white">Payment</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="contact.html"style="color: white">Notice</a>
                        </li>
                        <li class="nav-item">
