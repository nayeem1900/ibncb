    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Manage School</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>Edit About School

                                    <a class="btn btn-success float-right btn-sm" href="{{route('missions.view')}}"><i class="fa fa-list"></i>About School List</a>
                                </h3>
